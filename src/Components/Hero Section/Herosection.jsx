...
export default function HeroSection() {
    ...
    return (
      <div className="bg-gradient-to-br from-[#d1d5db] via-[#6b7280] to-[#374151] min-h-[85vh] relative overflow-hidden rounded-3xl m-4 md:m-6 md:p-16 transition-all duration-300">
